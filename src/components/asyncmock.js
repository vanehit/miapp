...
const products = [
    ...
    { id: 16, 
        name: 'Bandeja Metal Enrejada 2 Pisos Verd Manzana Values', 
        price: 2947, 
        category: 'comercial', 
    ...
    { id: 17, 
        name: 'Portaclips Con Iman Redondo Grande', 
        price: 435, 
        category: 'comercial', 
    ...
    { id: 18, 
        name: 'Organizador Liggo O-life Cuadrado Rojo S929', 
        price: 1329, 
        category: 'comercial', 
    ...
    { id: 26, 
        name: 'El Jardin Secreto Colorea Y Encuentra Los Tesoros Escondidos', 
        price: 1266, 
        category: 'regaleria', 
